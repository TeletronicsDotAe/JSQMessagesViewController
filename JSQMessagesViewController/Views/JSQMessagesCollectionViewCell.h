...
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleContainerWidthConstraint;

@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *textViewTopVerticalSpaceConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *textViewBottomVerticalSpaceConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *textViewAvatarHorizontalSpaceConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *textViewMarginHorizontalSpaceConstraint;

@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *cellTopLabelHeightConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *messageBubbleTopLabelHeightConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *cellBottomLabelHeightConstraint;

@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *avatarContainerViewWidthConstraint;
@property (readwrite, weak, nonatomic) IBOutlet NSLayoutConstraint *avatarContainerViewHeightConstraint;
 ...
 */
@property (weak, nonatomic, readwrite) IBOutlet JSQMessagesLabel *cellTopLabel;
 ...
 */
@property (weak, nonatomic, readwrite) IBOutlet JSQMessagesLabel *messageBubbleTopLabel;
 ...
 */
@property (weak, nonatomic, readwrite) IBOutlet JSQMessagesLabel *cellBottomLabel;
 ...
 */
@property (weak, nonatomic, readwrite) IBOutlet JSQMessagesCellTextView *textView;
